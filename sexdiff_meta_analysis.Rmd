...
beta_es <- read.csv("./results/SRS_data/beta_es.csv", header=1)
...
mod_ho <- rma.mv(yi, vi, slab = Authors,random = list(~ 1 | Protocol/Authors), mod = ~dietary_intervention -1,data = beta_es[beta_es$metric == "Jaccard",], method = "REML")
orchaRd::mod_results(mod_ho, mod="1", group = "Authors")
orchaRd::mod_results(mod_ho, mod="dietary_intervention", group = "Authors")
p1 <- orchaRd::orchard_plot(mod_ho, mod = "dietary_intervention", group = "Authors")
